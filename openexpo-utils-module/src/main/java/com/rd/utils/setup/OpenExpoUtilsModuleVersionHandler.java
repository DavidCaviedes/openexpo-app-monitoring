...
import com.rd.utils.constants.IConstantsModuleNames;
 ...
 */
public class OpenExpoUtilsModuleVersionHandler extends DefaultModuleVersionHandler {

	private static String MODULE_NAME = IConstantsModuleNames.MODULE_NAME_UTILS;
	private static String MODULE_DESCRIPTION = IConstantsVersionHandler.MAGNOLIA_VERSION_TEXT  + " - " + MODULE_NAME;
	
	public OpenExpoUtilsModuleVersionHandler() {
		super();
